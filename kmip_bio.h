...
int kmip_bio_get_symmetric_key_with_context(KMIP *, BIO *, char *, int, enum cryptographic_algorithm *, char **, int *);
int kmip_bio_destroy_symmetric_key_with_context(KMIP *, BIO *, char *, int);
int kmip_bio_locate_with_context (KMIP *, BIO *, Attribute *,  int attribute_count, int maximum_items, int*, char **, int *);
